...
mae_score <- score(fc_with_truth, MAE())
rmse_score <- score(fc_with_truth, RMSE())
mape_score <- score(fc_with_truth, MAPE())
...
- `CRPS()` - Continuous Ranked Probability Score (requires intervals)
- `WIS()` - Weighted Interval Score (requires intervals)
